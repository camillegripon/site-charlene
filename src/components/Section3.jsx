...
export default function Section3() {
  return (
      <section className="section alt-section" id="formation">
        <h2>Approche psychosexologique</h2>
        <div className="cards">
          <div className="card">
            <p>Formée aux techniques diagnostiques et thérapeutiques en sexologie, je propose également des entretiens psychosexologiques, destinés à accompagner chaque individus avec ou sans leur(s) partenaire(s) dans leurs questionnements relatifs à leur vie affective, relationnelle et sexuelle.
